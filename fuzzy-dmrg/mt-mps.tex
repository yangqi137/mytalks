...
\begin{tikzpicture}[
    ...
    %}
    %\node[below=1.2cm of C, label text, text width=4cm, align=center] {Physical indices \\ (Landau Level orbitals)};

    % Target State Bond (Vertical Up - Key Innovation)
    \draw[targetleg] (C) -- (0, 1.2) node[above, text=red!80!black, font=\bfseries] {Target State Index $\alpha \in \{1, 2, \dots, m\}$};
