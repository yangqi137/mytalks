...
\begin{frame}{Collaborators}
  \begin{itemize}
  \item Jin-Xiang Hao: Fudan University.
  \item Zheng Zhu: Kavli Institute of Theoretical Sciences, UCAS.
\end{itemize}
\vspace{4em}
\begin{center}
...
\begin{frame}{State-Operator Correspondence}
  \begin{itemize}
  \item Each eigenstate $|\psi\rangle$ corresponds to an operator $\psi$ in the CFT.
...
\begin{frame}{Targeting Symmetry Sectors}
  \begin{columns}
    ...
    \item $\mathrm{SO}(3)$ symmetry: we target the sector of certain $L$ by adding $\vec L^2$ to the Hamiltonian
    ...
    \begin{tabular}{|c|c|c|c|c|c|}
      ...
      \cline{3-6}
                                     & & 0 & 1 & 2 & 3\\
      \hline
      \multirow{3}{*}{1} & 0 & $I$ & $\epsilon$ & $\Box\epsilon$ & $\epsilon^\prime$ \\
      \cline{2-6}               
      ...
      \hline
      \multirow{3}{*}{-1} & 0 & $\sigma$ & $\Box\sigma$ & $\Box^2\sigma$ & $\sigma^\prime$ \\ 
      \cline{2-6}
