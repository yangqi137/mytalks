...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{center}
			\includegraphics[height=1.5cm]{../dimer/weak3d_2d_blue}
		\end{center}
...
\node<2-> at (3, 2) (D1) [draw, rectangle] {$\mathcal D_1?$};
\node<2-> at (3, -2) (D2) [draw, rectangle] {$\mathcal D_2?$};
\node<2-> at (3, -3) {$\vdots$};
\draw<2-> [->] (C)--(D) node [midway, above] {{\small $q_{\mathcal C\rightarrow\mathcal D}$}};
\draw<2-> [->] (C)--(D1);
\draw<2-> [->] (C)--(D2);
\node<3-> at (6, 1.5) (DD) [draw, circle] {$\mathcal D$};
\node<3-> at (6, -1.5) (DC) [draw, circle] {$\mathcal C$};
\draw<3-> [->] (D)--(DD) node [midway, above] {{\small $\alpha_{\mathcal C\rightarrow\mathcal D}$}};
\draw<3-> [->] (D)--(DC);
\end{tikzpicture}
\column{.6\textwidth}
{\small
...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[width=\textwidth]{../eqmc/combine2}
  \end{center}
  \begin{itemize}
...
\begin{frame}{Cumulative update}
  ...
  \end{itemize}
	\begin{center}
		\includegraphics[width=6cm]{cum-update}
	\end{center}
\end{frame}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[height=3cm]{fslmc-autocorr}
	\end{center}
	\begin{itemize}
