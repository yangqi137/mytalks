...
\begin{frame}
    ...
    \begin{frame}
      ...
      \end{center}
      \column{.4\textwidth}
      \[|\Psi\rangle=\sum_{\{g_i\}}\Bigg|\includegraphics[height=1cm]{../chainmap/decoration.png}\Bigg>\]
      \end{columns}
    \end{frame}
    ...
    \begin{frame}{Example: class DIII}
      ...
      \begin{itemize}
        ...
        \item $K_{X_3}=\mathbb Z_4$: For each $\alpha\in K_{X_2}$, solve $d\beta=\alpha$ and check $\beta-c_4\cdot\beta\in \mathcal H^3(\mathbb Z_2^T)=\mathbb Z_2$.
